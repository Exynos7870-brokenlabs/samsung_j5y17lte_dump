...
cat system/app/SBrowser_7.2/SBrowser_7.2.apk.* 2>/dev/null >> system/app/SBrowser_7.2/SBrowser_7.2.apk
rm -f system/app/SBrowser_7.2/SBrowser_7.2.apk.* 2>/dev/null
