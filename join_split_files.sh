...
cat system/app/SBrowser_9.2/SBrowser_9.2.apk.* 2>/dev/null >> system/app/SBrowser_9.2/SBrowser_9.2.apk
rm -f system/app/SBrowser_9.2/SBrowser_9.2.apk.* 2>/dev/null
